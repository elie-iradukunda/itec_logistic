  ...
  <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    <nav class="vertnav navbar navbar-light">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        <li class="nav-item w-100"><a class="nav-link" href="<?= url('dashboard') ?>"><i class="fe fe-home fe-16"></i><span class="ml-3 item-text">Dashboard</span></a></li>
        <?php if (role_can('vehicles') || role_can('drivers') || role_can('maintenance')): ?><li class="nav-item dropdown"><a href="#fleetMenu" data-toggle="collapse" class="dropdown-toggle nav-link"><i class="fe fe-truck fe-16"></i><span class="ml-3 item-text">Fleet Management</span></a><ul class="collapse list-unstyled pl-4 w-100" id="fleetMenu"><?php if (role_can('vehicles')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('vehicles') ?>"><span class="ml-1 item-text">Vehicles</span></a></li><?php endif; ?><?php if (role_can('drivers')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('drivers') ?>"><span class="ml-1 item-text">Drivers</span></a></li><?php endif; ?><?php if (role_can('maintenance')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('maintenance') ?>"><span class="ml-1 item-text">Maintenance</span></a></li><?php endif; ?></ul></li><?php endif; ?>
        <?php if (role_can('trips') || role_can('deliveries') || role_can('requests')): ?><li class="nav-item dropdown"><a href="#transportMenu" data-toggle="collapse" class="dropdown-toggle nav-link"><i class="fe fe-map-pin fe-16"></i><span class="ml-3 item-text">Transport</span></a><ul class="collapse list-unstyled pl-4 w-100" id="transportMenu"><?php if (role_can('trips')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('trips') ?>"><span class="ml-1 item-text">Trips</span></a></li><?php endif; ?><?php if (role_can('deliveries')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('deliveries') ?>"><span class="ml-1 item-text">Deliveries</span></a></li><?php endif; ?><?php if (role_can('requests')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('requests') ?>"><span class="ml-1 item-text">Transport requests</span></a></li><?php endif; ?></ul></li><?php endif; ?>
        <?php if (role_can('fuel') || role_can('expenses')): ?><li class="nav-item dropdown"><a href="#financeMenu" data-toggle="collapse" class="dropdown-toggle nav-link"><i class="fe fe-credit-card fe-16"></i><span class="ml-3 item-text">Finance</span></a><ul class="collapse list-unstyled pl-4 w-100" id="financeMenu"><?php if (role_can('fuel')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('fuel') ?>"><span class="ml-1 item-text">Fuel management</span></a></li><?php endif; ?><?php if (role_can('expenses')): ?><li class="nav-item"><a class="nav-link pl-3" href="<?= url('expenses') ?>"><span class="ml-1 item-text">Logistics expenses</span></a></li><?php endif; ?></ul></li><?php endif; ?>
        <?php if (role_can('warehouse')): ?><li class="nav-item"><a class="nav-link" href="<?= url('warehouse') ?>"><i class="fe fe-package fe-16"></i><span class="ml-3 item-text">Warehouse</span></a></li><?php endif; ?>
        <?php if (role_can('procurement')): ?><li class="nav-item"><a class="nav-link" href="<?= url('procurement') ?>"><i class="fe fe-shopping-cart fe-16"></i><span class="ml-3 item-text">Procurement</span></a></li><?php endif; ?>
        <?php if (role_can('reports')): ?><li class="nav-item dropdown"><a href="#reportsMenu" data-toggle="collapse" class="dropdown-toggle nav-link"><i class="fe fe-bar-chart-2 fe-16"></i><span class="ml-3 item-text">Reports</span></a><ul class="collapse list-unstyled pl-4 w-100 logistics-report-menu" id="reportsMenu"><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports') ?>"><span class="ml-1 item-text">All reports</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Vehicle utilization']) ?>"><span class="ml-1 item-text">Vehicle utilization</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Fuel consumption']) ?>"><span class="ml-1 item-text">Fuel consumption</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Delivery performance']) ?>"><span class="ml-1 item-text">Delivery performance</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Maintenance cost']) ?>"><span class="ml-1 item-text">Maintenance cost</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Driver performance']) ?>"><span class="ml-1 item-text">Driver performance</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Inventory movement']) ?>"><span class="ml-1 item-text">Inventory movement</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Trip profitability']) ?>"><span class="ml-1 item-text">Trip profitability</span></a></li><li class="nav-item"><a class="nav-link pl-3" href="<?= url('reports', ['report_type' => 'Expense summary']) ?>"><span class="ml-1 item-text">Expense summary</span></a></li></ul></li><?php endif; ?>
        <?php if (role_can('users')): ?><li class="nav-item"><a class="nav-link" href="<?= url('users') ?>"><i class="fe fe-users fe-16"></i><span class="ml-3 item-text">Users & permissions</span></a></li><?php endif; ?>
      </ul>
